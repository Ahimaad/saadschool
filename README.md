...
🌐 زيارة الموقع · 🐛 الإبلاغ عن مشكلة · 💡 اقتراح ميزة
</div>
---
✨ المميزات
الميزة	الوصف
...
أنشئ مشروعاً جديداً أو استخدم الموجود
فعّل Realtime Database واضبط القواعد:
```json
{
  "rules": {
    "results": {
...
```
أضف دومين GitHub Pages في Authentication → Settings → Authorized Domains:
```
   username.github.io
   ```
---
